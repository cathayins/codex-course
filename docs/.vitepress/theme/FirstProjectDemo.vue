...
const overviewSteps = [
  { title: '建立資料夾並在 Codex 打開', description: '放入 Marketing Excel，再從 Codex 選擇「使用現有資料夾」。' },
...
const prompts: { label: string; parts: PromptPart[] }[] = [
  ...
  },
  {
    ...
    parts: [
      { text: '請讀取 ' },
      { text: '@Marketing_Campaign_Data.xlsx', mention: true },
      { text: '，整理每張工作表的用途、資料期間與指標定義，提出製作 Marketing Dashboard 需要注意的資料限制。' },
    ],
  },
  {
    label: '規劃 Dashboard',
    parts: [
      { text: '/plan\n\n請基於 ' },
      { text: '@Marketing_Campaign_Data.xlsx', mention: true },
      { text: '，規劃如何產出一份可互動的 Marketing Dashboard。請先提出指標定義、圖表、篩選器與驗收方式，不要建立最終成品。' },
    ],
  },
]
...
<template>
  ...
  <section v-else-if="mode === 'folder'" class="fp-demo fp-folder-demo" aria-label="在 Codex 打開工作資料夾的動畫示意">
    ...
    <div class="fp-app">
      ...
      <aside class="fp-app__sidebar">
        ...
        <div v-if="folderPhase === 3" class="fp-app__project is-selected">▱ codex-demo</div>
      ...
      <main class="fp-app__main">
        <div class="fp-app__welcome">
          ...
          <b>{{ folderPhase === 3 ? 'codex-demo' : '開始一個 Codex 任務' }}</b>
          ...
          <div v-if="folderPhase === 2" class="fp-finder" role="presentation">
            ...
            <div class="fp-finder__body">
              ...
              <main>
                ...
                <div class="is-selected"><i></i><span>codex-demo</span></div>
  ...
  >
    <div class="fp-composer fp-composer--model">
      <p>請先盤點這個資料夾，確認是否有 Marketing Excel。</p>
